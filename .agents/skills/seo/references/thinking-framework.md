...
This is the canonical methodology seo-skills uses to assemble raw findings
...
- Surface what seo-skills itself **could not measure** (offline
...
These principles are seo-skills's; they are not the user's. Surface them
for the user when:
